...
// the enemy / pot / bush prize packs (7 packs of 8).  Writable because the
// randomizer's RETRO row rewrites the arrow entries - see sprite.c.
extern uint8 kPrizeItems[56];
